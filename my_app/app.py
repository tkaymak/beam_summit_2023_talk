...
# It is important that the messages receive their original timestamp when they are published. The script is not part of this repo.
# 
# The pipeline starts and reads from two Pub/Sub topics (one with the core, one with the lookup updates)
# 1. Both streams are mapped to NamedTuple
# 2. A flatten unites the two PCollections
# 3. A StatefulDoFn with timers reads the elements
# 
